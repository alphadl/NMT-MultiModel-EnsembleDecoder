...
def _check_save_model_path(opt):
    # logger.info("unprocessed save_model path=%s"%opt.save_model)
...
def main(opt):
    ...
    # flag
    logger.info("this model has been loaded")

    # Do training.
    trainer.train(train_iter_fct, valid_iter_fct, opt.train_steps,
                  opt.valid_steps)
    # flag
    logger.info("this model has finished the training process")
