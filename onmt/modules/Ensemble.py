...
class EnsembleEncoder(EncoderBase):
    ...
    def forward(self, src, lengths=None, encoder_state=None):
        # print ">>>>>>>此处的forward地址为：",self.model_encoders.forward.__name__

        # enc_hidden, memory_bank = self.model_encoders[0].forward(src, lengths, encoder_state,)
...
class EnsembleDecoder(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None):
        ...
        # This assumption will nd'd'd'dddf Translator is modified
